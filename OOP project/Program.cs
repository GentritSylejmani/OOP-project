...
namespace OOP_project
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Lists.ClientsList.Add(new Contributor { Name = "Afrim", Surname = "Sylejmani", Email = "gentrit.sylejmani@riinvest.net", Username = "afrim", Password = "Genti.11", UserType = Person.usertype.Client, PersonalNo = "1170808050", PhoneNo = "+38345216333", AccountNo = 46373, Credit = 500.00 });
